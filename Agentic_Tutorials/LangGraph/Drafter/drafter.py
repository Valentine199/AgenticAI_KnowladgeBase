...
def update(content : str) -> str:
    ...
    return f"The document has been updated. Current content is: {document_content}"
...
def our_agent(state: AgentState) -> AgentState:
    syste_prompt = SystemMessage(content=f"""
    ...
    all_messages = [syste_prompt] + list(state["messages"]) + [user_message]
